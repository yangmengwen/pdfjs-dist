...
// rewrite by sunburst at 20180714
function bak_20180714parseQueryString(query) {
...
function parseQueryString(query) {
  ...
  var firstIndex = parts.indexOf('=');
  var key = parts.substr(0, firstIndex);
  var value = parts.substr(firstIndex+1, parts.length);
//  params[decodeURIComponent(key)] = decodeURIComponent(value);
//  alert(key+'='+value);
  params[key] = value;
  return params;
